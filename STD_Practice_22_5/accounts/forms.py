...
class UserRegistrationForm(UserCreationForm):
    ...
    def save(self, commit = True):
        ...
        print(our_user,self.cleaned_data)
        if commit == True:
            our_user.save()
            ...
            UserAddress.objects.create(user=our_user,street_address=street_address,city=city,postal_code=postal_code,country=country)
